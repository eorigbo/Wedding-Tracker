...
class WeddingsControllerTest < ActionController::TestCase
  ...
  test "should create wedding" do
    assert_difference('Wedding.count') do
      post :create, wedding: { date: @wedding.date, expected_guests: @wedding.expected_guests, location: @wedding.location, name: @wedding.name, user_id: @wedding.user_id }
    end
  ...
  test "should update wedding" do
    patch :update, id: @wedding, wedding: { date: @wedding.date, expected_guests: @wedding.expected_guests, location: @wedding.location, name: @wedding.name, user_id: @wedding.user_id }
    assert_redirected_to wedding_path(assigns(:wedding))
  end
